  ...
  <header className={styles.widget}>
    <nav className={styles.widget__title}>
      <ul className={styles.widget__list}>
        <li><NavLink className={styles.widget__a} to={'/'} style={({isActive}) => ({color: isActive ? 'red' : 'blue'})}>Main</NavLink></li>
        {/*<li><NavLink className={styles.widget__a} to={'/general'} style={({isActive}) => ({color: isActive ? 'red' : 'blue'})}>general</NavLink></li>*/}
        <li><NavLink className={styles.widget__a} to={'/settings'} style={({isActive}) => ({color: isActive ? 'red' : 'blue'})}>Settings</NavLink></li>
